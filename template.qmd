...
A solution to typeset pseudocode just like you would do with $\LaTeX$, yet with HTML output is to rely on the JavaScript [pseudocode.js](https://github.com/SaswatPadhi/pseudocode.js). Your pseudocode is written inside a `<pre class="pseudocode">` tag. Do not forget the class tag, that will trigger the rendering process of your pseudo-code. 
