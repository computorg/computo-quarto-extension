...
author:
  ...
  - name: a friend
    affiliations:
      - Another Affiliation
description: |
  This document provides a template based on the quarto system for contributions to Computo. We show how Python (Perez, Granger, and Hunter 2011) or R (R Core Team 2020) code can be included. The github repository in itself can be used to install the quarto corresponding extension useful for authors.
abstract: |
